...
export default async function SkillsPage() {
    ...
    return (
        <MainCardLayout title={t("skills.title")}>
            <div className="grid md:grid-cols-5 lg:grid-cols-7 sm:grid-cols-3 grid-cols-2 gap-4 p-4 overflow-y-auto md:h-auto h-[var(--main-card-height)]" style={{'--main-card-height': "calc(100svh - 2rem - 3rem - 3rem)"} as CSSProperties}> 
